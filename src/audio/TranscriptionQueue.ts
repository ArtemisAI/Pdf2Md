 ...
 * Manages asynchronous audio transcription tasks
 */
...
export class TranscriptionQueue {
  ...
  private async processTask(task: TranscriptionTask): Promise<void> {
    ...
    try {
      ...
      tracker.complete('Transcription completed successfully');
